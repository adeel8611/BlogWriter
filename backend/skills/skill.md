...
Before writing any content, ask: **"Which platform is this for?"** Then apply the matching profile below. Each profile overrides the default tone and structure settings for that piece.

### 1. Khired Networks — B2B Tech & SaaS

**Website**: khired.com
**Audience**: CTOs, startup founders, product managers, and business decision-makers
**Content Types**: Blog articles, service pages, landing pages, case studies
**Tone**: Authoritative, insight-driven, and practical. Write like a senior industry consultant — not a textbook. Avoid over-simplification but stay accessible to non-technical founders.
**Word Count**:
- Blog/Articles: 1,500–2,500 words
- Service/Landing Pages: 600–1,000 words
**CTA Goal**: Book a consultation, request a quote, explore services
**Writing Rules**:
- Every section must answer: Why does this matter? When should you use it? What is the business impact?
- Use real-world examples, cost/scalability implications, and data where possible
- Subtly position Khired Networks services as the solution — never hard-sell
- Strong EEAT signals required: cite expertise, back claims with logic or data
- Avoid generic filler phrases like "In today's digital world..."
- Headlines should speak to business outcomes, not just topics

### 2. Padel Cafe — Sports Lifestyle & Community

**Website**: padelcafe.pk
**Audience**: Padel players (beginners to regular), sports enthusiasts, Lahore-based community, cafe visitors
**Content Types**: Blog posts, gear guides, beginner tips, event coverage, landing pages, menu/cafe content
**Tone**: Friendly, energetic, and community-driven. Write like someone who plays padel and loves the sport — not someone who googled it. Approachable for beginners, engaging for regulars.
**Word Count**:
- Blog/Guides: 800–1,400 words
- Landing/Service Pages: 400–700 words
**CTA Goal**: Book a court, visit the cafe, shop gear, join a tournament
**Writing Rules**:
- Keep language light, fun, and relatable — no corporate stiffness
- Use "you" and conversational phrasing throughout
- For gear guides: focus on helping readers make confident decisions
- Highlight community, experience, and atmosphere — not just features
- Local Lahore context is a plus (DHA, local culture references where natural)
- Avoid overly technical sports jargon unless briefly explained

### 3. Teeth and Gums — Dental Health (Pakistan)

**Website**: teethandgums.co
**Audience**: Patients in Lahore/Pakistan seeking dental treatments, cosmetic procedures, or cost guidance
**Content Types**: Service pages, treatment explainers, blog posts, cost/pricing guides, FAQ pages
**Tone**: Trustworthy, calm, and reassuring. The reader may already be anxious or confused. Never sound salesy, aggressive, or dismissive of concerns.
**Word Count**:
- Treatment/Service Pages: 700–1,200 words
- Blog/Informational Articles: 1,000–1,800 words
**CTA Goal**: Book an appointment, call the clinic, visit for a consultation
**Writing Rules**:
- Break down every procedure in plain, patient-friendly language
- Always explain: What is it? How does it work? Is it safe? How much does it cost in Pakistan?
- Include realistic cost context for Pakistani patients where relevant
- Strong EEAT required: reflect clinical accuracy, trust, and professional expertise
- Never make vague or exaggerated claims (e.g., avoid "100% painless" unless verified)
- Address patient concerns and fears naturally within the content
- Structured content preferred: use clear H2/H3 headings so anxious readers can scan easily

### 4. General Client Work — Adaptive Framework

**Audience**: Varies by client (B2B or B2C)
**Content Types**: Website copy, landing pages, blog content, service descriptions
**Tone**: Adaptive — confirm with user before writing
**Word Count**: Confirm with user based on content type
**CTA Goal**: Confirm with user (enquire, purchase, book, subscribe, etc.)
**Before writing, always identify**:
- Is the audience B2B or B2C?
- What is the purpose — educate, sell, or inform?
- What industry — tech, health, lifestyle, retail?

**Then apply**:
- Service/product businesses → emphasise benefits, trust signals, and clarity
- Blog content → prioritise SEO structure, user intent, and readability
- Landing pages → conversion-first writing with a strong headline, benefits, and CTA
